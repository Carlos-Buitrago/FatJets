...
int TMVAClassificationNsubjettiness( TString myMethodList = "" )
{
   ...
   // I TURNED OFF PDEFoam and SVM and Cuts
   // I ALSO TURNED OFF Likelihood, LikelihoodPCA, KNN, LD, FDA_GA, MLPBNN, Rulefit.
   ...
   std::cout << "--- TMVAClassification       : Using input files: " << input1->GetName() << " and " << input2->GetName() << std::endl;
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=225000:nTrain_Background=225000:SplitMode=Random:NormMode=NumEvents:!V" );
