...
inline void ReadMLPBNN::Initialize()
{
   ...
   fWeightMatrix0to1[0][0] = -4.32744648844363;
   fWeightMatrix0to1[1][0] = 2.68598638665385;
   fWeightMatrix0to1[2][0] = 0.863616355850589;
   fWeightMatrix0to1[3][0] = 2.73000007510022;
   fWeightMatrix0to1[4][0] = -3.2224277131387;
   fWeightMatrix0to1[5][0] = -2.17853960277421;
   fWeightMatrix0to1[6][0] = -0.43013741269066;
   fWeightMatrix0to1[7][0] = 1.9681370247457;
   fWeightMatrix0to1[8][0] = -1.41535398608042;
   fWeightMatrix0to1[9][0] = -2.12652042847574;
   fWeightMatrix0to1[0][1] = -4.07552142192831;
   fWeightMatrix0to1[1][1] = 0.143633580964102;
   fWeightMatrix0to1[2][1] = -1.2814458923465;
   fWeightMatrix0to1[3][1] = 0.236353796836021;
   fWeightMatrix0to1[4][1] = -2.26444164809777;
   fWeightMatrix0to1[5][1] = 0.152603358265577;
   fWeightMatrix0to1[6][1] = -0.00922798788406082;
   fWeightMatrix0to1[7][1] = 1.75803470084185;
   fWeightMatrix0to1[8][1] = 0.154219349185273;
   fWeightMatrix0to1[9][1] = -1.32229233167563;
   fWeightMatrix0to1[0][2] = 0.214754616711221;
   fWeightMatrix0to1[1][2] = -0.289144009106878;
   fWeightMatrix0to1[2][2] = 0.726095097944903;
   fWeightMatrix0to1[3][2] = 0.488109662155209;
   fWeightMatrix0to1[4][2] = 1.12912242876032;
   fWeightMatrix0to1[5][2] = -0.667404911055571;
   fWeightMatrix0to1[6][2] = 1.71867983361155;
   fWeightMatrix0to1[7][2] = -1.10005328881428;
   fWeightMatrix0to1[8][2] = -1.89082023081962;
   fWeightMatrix0to1[9][2] = -0.661661723086091;
   fWeightMatrix0to1[0][3] = 0.692180991709322;
   fWeightMatrix0to1[1][3] = 1.89994471517599;
   fWeightMatrix0to1[2][3] = -0.343263923599882;
   fWeightMatrix0to1[3][3] = -0.376840638739208;
   fWeightMatrix0to1[4][3] = 0.687630222278099;
   fWeightMatrix0to1[5][3] = -0.536118094444782;
   fWeightMatrix0to1[6][3] = -1.36734158085888;
   fWeightMatrix0to1[7][3] = 1.74261270552843;
   fWeightMatrix0to1[8][3] = -1.21104184056175;
   fWeightMatrix0to1[9][3] = 1.37081469365879;
   fWeightMatrix0to1[0][4] = 2.55923088788683;
   fWeightMatrix0to1[1][4] = 1.04572894774846;
   fWeightMatrix0to1[2][4] = 1.85785223406869;
   fWeightMatrix0to1[3][4] = 0.791322685603652;
   fWeightMatrix0to1[4][4] = -1.90303642289318;
   fWeightMatrix0to1[5][4] = -1.83350244699094;
   fWeightMatrix0to1[6][4] = 0.783532364464017;
   fWeightMatrix0to1[7][4] = 0.0620257796987519;
   fWeightMatrix0to1[8][4] = 1.49946195582108;
   fWeightMatrix0to1[9][4] = 2.24067459327817;
   fWeightMatrix0to1[0][5] = -4.28688565164869;
   fWeightMatrix0to1[1][5] = 0.470538958394096;
   fWeightMatrix0to1[2][5] = -1.63798022721905;
   fWeightMatrix0to1[3][5] = 0.158823418171148;
   fWeightMatrix0to1[4][5] = -3.3901716380075;
   fWeightMatrix0to1[5][5] = -0.0852710045234117;
   fWeightMatrix0to1[6][5] = -1.58679150012376;
   fWeightMatrix0to1[7][5] = -1.71523321096329;
   fWeightMatrix0to1[8][5] = 1.51747769233083;
   fWeightMatrix0to1[9][5] = 0.556329447136962;
   // weight matrix from layer 1 to 2
   fWeightMatrix1to2[0][0] = -4.21979649027534;
   fWeightMatrix1to2[0][1] = -0.313691704885235;
   fWeightMatrix1to2[0][2] = 0.571307435074945;
   fWeightMatrix1to2[0][3] = 0.068763160673721;
   fWeightMatrix1to2[0][4] = 3.94807852012106;
   fWeightMatrix1to2[0][5] = 0.0520533681290634;
   fWeightMatrix1to2[0][6] = 0.289945821012467;
   fWeightMatrix1to2[0][7] = -0.317802255978976;
   fWeightMatrix1to2[0][8] = -0.181890048097883;
   fWeightMatrix1to2[0][9] = -2.0340140118898;
   fWeightMatrix1to2[0][10] = -1.66742389335976;
}
