...
void drawHistograms() {
  ...
  TH1F *histo1 = (TH1F*)file->Get("dataset/InputVariables_Id/mass__Signal_Id");
  TH1F *histo2 = (TH1F*)file->Get("dataset/InputVariables_Id/mass__Background_Id");
  ...
  histo1->SetTitle("Fat jet mass");
  histo2->SetTitle("Fat jet mass");
  ...
  legend->AddEntry(histo1, "#font[12]{W} Signal", "f");
  legend->AddEntry(histo2, "QCD Background", "f");
  legend->Draw();

  // Save the canvas as a pdf file
  canvas->SaveAs("W_mass_distribution.pdf");
