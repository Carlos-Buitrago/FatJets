...
// Thu Apr 20 14:58:47 2023 by ROOT version 6.28/02
// from TTree Delphes/Analysis tree
// found on file: ../pp_WW_hadronic_14TeV500kEvtsGenCutW350_CutQCD350_InclusiveCut350_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef TreeModifierClass_W_h
#define TreeModifierClass_W_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4475;
   static constexpr Int_t kMaxTrack = 272;
   static constexpr Int_t kMaxTower = 592;
   static constexpr Int_t kMaxEFlowTrack = 272;
   static constexpr Int_t kMaxEFlowPhoton = 350;
   ...
   TreeModifierClass_W(TTree *tree=0);
   virtual ~TreeModifierClass_W();
...
#ifdef TreeModifierClass_W_cxx
TreeModifierClass_W::TreeModifierClass_W(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../pp_WW_hadronic_14TeV500kEvtsGenCutW350_CutQCD350_InclusiveCut350_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../pp_WW_hadronic_14TeV500kEvtsGenCutW350_CutQCD350_InclusiveCut350_delphes_events.root", "UPDATE");
      }
...
TreeModifierClass_W::~TreeModifierClass_W()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TreeModifierClass_W::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TreeModifierClass_W::LoadTree(Long64_t entry)
{
...
void TreeModifierClass_W::Init(TTree *tree)
{
...
Bool_t TreeModifierClass_W::Notify()
{
...
void TreeModifierClass_W::Show(Long64_t entry)
{
...
Int_t TreeModifierClass_W::Cut(Long64_t entry)
{
...
#endif // #ifdef TreeModifierClass_W_cxx
