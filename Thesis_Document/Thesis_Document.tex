...
\def\biblio{\bibliographystyle{plainnat}\bibliography{\main/Thesis_bib}}
...
\bibliographystyle{plainnat} %%bib style found in bst folder, in bibtex folder, in texmf folder.
