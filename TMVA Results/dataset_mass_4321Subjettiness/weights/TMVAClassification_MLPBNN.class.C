...
inline void ReadMLPBNN::Initialize()
{
   ...
   fWeightMatrix0to1[0][0] = -1.6759228064647;
   fWeightMatrix0to1[1][0] = 2.91102706435209;
   fWeightMatrix0to1[2][0] = 0.853619205814637;
   fWeightMatrix0to1[3][0] = 4.44532215300672;
   fWeightMatrix0to1[4][0] = -5.3868661115004;
   fWeightMatrix0to1[5][0] = -0.926085919098734;
   fWeightMatrix0to1[6][0] = -1.348567630679;
   fWeightMatrix0to1[7][0] = 1.94662346504732;
   fWeightMatrix0to1[8][0] = -1.44816284695784;
   fWeightMatrix0to1[9][0] = -0.344171544540066;
   fWeightMatrix0to1[0][1] = -4.19577554398854;
   fWeightMatrix0to1[1][1] = -2.23803937576377;
   fWeightMatrix0to1[2][1] = -1.25749923811316;
   fWeightMatrix0to1[3][1] = 2.28536966542146;
   fWeightMatrix0to1[4][1] = -1.36334514370009;
   fWeightMatrix0to1[5][1] = 1.7679504087272;
   fWeightMatrix0to1[6][1] = 0.828072644016504;
   fWeightMatrix0to1[7][1] = 1.77943496264083;
   fWeightMatrix0to1[8][1] = 0.177304818058152;
   fWeightMatrix0to1[9][1] = 1.09175640746662;
   fWeightMatrix0to1[0][2] = -1.87261509073001;
   fWeightMatrix0to1[1][2] = 0.666378958609467;
   fWeightMatrix0to1[2][2] = 0.755133758704065;
   fWeightMatrix0to1[3][2] = -1.40589638971118;
   fWeightMatrix0to1[4][2] = -3.06578521850784;
   fWeightMatrix0to1[5][2] = -1.80436558814194;
   fWeightMatrix0to1[6][2] = 2.0985234053664;
   fWeightMatrix0to1[7][2] = -1.09587113590951;
   fWeightMatrix0to1[8][2] = -1.87256492367922;
   fWeightMatrix0to1[9][2] = 0.373551238114541;
   fWeightMatrix0to1[0][3] = 2.98746579204035;
   fWeightMatrix0to1[1][3] = 0.955517577500513;
   fWeightMatrix0to1[2][3] = -0.274735821785609;
   fWeightMatrix0to1[3][3] = -0.174143481040148;
   fWeightMatrix0to1[4][3] = -2.69501265115238;
   fWeightMatrix0to1[5][3] = -0.197500732253804;
   fWeightMatrix0to1[6][3] = -1.53984960462223;
   fWeightMatrix0to1[7][3] = 1.76407191053074;
   fWeightMatrix0to1[8][3] = -1.25482430121469;
   fWeightMatrix0to1[9][3] = 1.99349972179652;
   fWeightMatrix0to1[0][4] = 5.12972147404709;
   fWeightMatrix0to1[1][4] = -2.33980804930927;
   fWeightMatrix0to1[2][4] = 1.90731392392147;
   fWeightMatrix0to1[3][4] = -0.807597752073229;
   fWeightMatrix0to1[4][4] = -4.2607662676572;
   fWeightMatrix0to1[5][4] = 0.255274562387464;
   fWeightMatrix0to1[6][4] = -0.623238102232142;
   fWeightMatrix0to1[7][4] = 0.0840658946602152;
   fWeightMatrix0to1[8][4] = 1.45090207992609;
   fWeightMatrix0to1[9][4] = 2.62057369426216;
   fWeightMatrix0to1[0][5] = -4.50683930952482;
   fWeightMatrix0to1[1][5] = 1.4759554041935;
   fWeightMatrix0to1[2][5] = -1.64083125654367;
   fWeightMatrix0to1[3][5] = 3.66810030594505;
   fWeightMatrix0to1[4][5] = 4.58920846514027;
   fWeightMatrix0to1[5][5] = -1.31966173248857;
   fWeightMatrix0to1[6][5] = -0.380828964098957;
   fWeightMatrix0to1[7][5] = -1.71187391478792;
   fWeightMatrix0to1[8][5] = 1.65345889430365;
   fWeightMatrix0to1[9][5] = -1.3001237871332;
   // weight matrix from layer 1 to 2
   fWeightMatrix1to2[0][0] = -4.83031230809277;
   fWeightMatrix1to2[0][1] = 2.23136885228498;
   fWeightMatrix1to2[0][2] = 1.35360668116284;
   fWeightMatrix1to2[0][3] = 4.65658951867146;
   fWeightMatrix1to2[0][4] = -3.79793993282671;
   fWeightMatrix1to2[0][5] = -1.65147362112292;
   fWeightMatrix1to2[0][6] = 1.81729202762274;
   fWeightMatrix1to2[0][7] = 0.445319078122224;
   fWeightMatrix1to2[0][8] = -1.05066894548901;
   fWeightMatrix1to2[0][9] = 0.38583717702451;
   fWeightMatrix1to2[0][10] = -2.42733085430865;
}
